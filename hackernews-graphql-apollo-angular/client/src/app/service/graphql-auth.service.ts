...
export class GraphqlAuthService {
  /**
   * Holds the id of the authorized user
   */
  public userId: string = null;
  /**
   * Holds the nick-name used by the authorized
   * user within the application
   */
  public userName: string = null;
  /**
   * Subscribeable BehaviorSubject that allows pushing
   * its state-changes within the application and implement
   * possibly needed side-effects
   */
